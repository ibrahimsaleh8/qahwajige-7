    ...
    <div>
        ...
        {whatsApp && (
          <motion.div
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#c73c0e] hover:bg-main-color text-white border-2 border-main-color-dark px-6 py-3.5 rounded-xl font-semibold text-base transition-all shadow-lg">
              احجز الآن
      ...
      <div className="mt-10 flex flex-wrap items-center justify-center gap-4 text-white/85 text-sm md:text-base">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="flex items-center gap-3 bg-white/5 rounded-2xl px-4 py-3 border border-white/10">
          <span className="text-2xl font-bold text-main-color">500+</span>
