        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              target="_blank"
              href={`tel:${telephone}`}
              className="bg-[#cf471a] hover:opacity-75 text-white md:px-6 md:py-3 px-4 py-2 text-sm md:text-base rounded-lg shadow-[0_4px_20px_hsl(var(--shadow-gold))] transition-all">
              احجز الآن
            </a>
          </div>
        </div>
